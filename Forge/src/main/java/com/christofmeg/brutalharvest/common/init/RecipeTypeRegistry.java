...
public class RecipeTypeRegistry {
    ...
    public static final RegistryObject<RecipeType<Cutting>> CUTTING_RECIPE_TYPE;
    ...
    static {
        ...
        CUTTING_RECIPE_TYPE = RECIPE_TYPES.register("cutting", () -> RecipeType.simple(new ResourceLocation(CommonConstants.MOD_ID, "cutting")));
    }
}
