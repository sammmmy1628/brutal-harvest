...
public class FryingCategory extends BaseBrutalRecipeCategory<Frying> {
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder iRecipeLayoutBuilder, @NotNull Frying frying, @NotNull IFocusGroup iFocusGroup) {
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.INPUT, this.getCentralX() - 45, this.getCentralY()).addIngredients(frying.ingredient());
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.INPUT, this.getCentralX() - 65, this.getCentralY()).addFluidStack(frying.fluidIngredient().getFluid(), frying.fluidIngredient().getAmount());
